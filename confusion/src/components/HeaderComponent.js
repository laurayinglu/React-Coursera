...
class Header extends Component {
  ...
  constructor(props) {
    ...
    this.toggleNav = this.toggleNav.bind(this); // toggleNav in js will be bind to the function toggleNav
  }
      ...
      <>
        <Navbar dark expand="md">
          <div className="container">
            {/* another way is to write as functional as before for onClick */}
